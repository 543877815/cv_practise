...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', default='log', type=str, help='output of log')
    ...
    parser.add_argument('--use_relative', default=False)
    ...
    trainset = torchvision.datasets.ImageFolder(root='F:\\DIV2K-train', transform=transform_train)
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=16, shuffle=True, num_workers=4)

    testset = torchvision.datasets.ImageFolder(root='F:\\DIV2K-test', transform=transform_train)
    ...
    def train(epoch):
        ...
        writer.add_scalar('train_correct_rate', correct / total, epoch)
        writer.add_scalar('train_loss', train_loss / total, epoch)
    ...
    def test(epoch):
        ...
        with torch.no_grad():
            ...
            writer.add_scalar('test_correct_rate', correct / total, epoch)
            writer.add_scalar('test_loss', test_loss / total, epoch)
